...
===============================================================
 Version: 1.0.0
 Last Updated: 2025-04-27 0936
 Author: Michael Williams
 Description: Flask-based API with GPT-4 + FAISS integration,
              discipline-sensitive response generation,
              operational (Accounting, Bookkeeping, Strategic Management) pathways,
              and Postmark email delivery.
===============================================================
 CHANGE LOG
===============================================================
 v1.0.0 — 2025-04-27
   • Initial Business API structure
   • Accounting FAISS index loaded
   • Discipline switching between Accounting, Bookkeeping, Strategic Management
   • Prepared for OpenAI integration and Render deployment
===============================================================
"""
import os
import faiss
